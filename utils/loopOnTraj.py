...
from loopo_actions.shape_overlap import SHAPE_OVERLAP
...
from loopo_actions.effective_charge import *
from loopo_actions.reset import *
from loopo_actions.wrap import *
from loopo_actions.timeshift import *
EXIT_FAILURE = 1
